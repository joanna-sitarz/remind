...
$setGlobal c_expname  SSP2-EU21-NPi
$setGlobal c_description  SSP2-EU21-NPi: This National Policies Implemented (NPi) scenario follows the Shared Socioeconomic Pathways 2 called Middle of the Road. The NPi assumes that policies fail to achieve NDC targets in 2030. Instead, carbon prices are assumed to grow and conve
...
$setglobal carbonprice  NPi           !! def = none
*'---------------------    46_carbonpriceRegi  ---------------------------------
*'
...
;
  cm_emiscen        = 9;               !! def = 1  !!  regexp = 0|1|4|6|9|10
...
;
  cm_budgetCO2from2020      = 0;   !! def = 1150
...
;
  cm_multigasscen     = 3;         !! def = 2  !! regexp = [1-3]
*' *  (1): CO2 only
*' *  (2): all GHG
...
$setglobal cm_rcp_scen  rcp45         !! def = "none"  !! regexp = none|rcp20|rcp26|rcp37|rcp45|rcp60|rcp85
