...
*JS _______________________________________________________________________

pm_pvp_exog(ttot,all_enty) = 100000000;
pm_pvp_exog(ttot,"pegas")$(ttot.val ge 2010) = 0.16;
pm_pvp_exog(ttot, "pecoal")$(ttot.val ge 2010) = 0.063;
pm_pvp_exog(ttot, "pebiolc")$(ttot.val ge 2010) = 0.3;
pm_pvp_exog(ttot, "peoil")$(ttot.val ge 2010) = 0.4;
pm_pvp_exog(ttot, "peur")$(ttot.val ge 2010) = 0.03;

vm_Mport_exog.fx(ttot, all_regi,all_enty)$(NOT entyPe(all_enty)) = 0;

vm_Mport_exog.up(ttot, "LAM", all_enty) = 2; 

vm_Mport.fx(ttot, all_regi,all_enty)$(ttot.val ge 2010) = 0;
vm_Xport.fx(ttot, all_regi,all_enty)$(ttot.val ge 2010) = 0;


*JS _________________________________________________________________________
